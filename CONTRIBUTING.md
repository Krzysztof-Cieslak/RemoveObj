...
your Operating System, as well as your `dotnet` (or `mono` \ .Net Framework), F# and RemoveObj versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/RemoveObj
   # Navigate to the newly cloned directory
   cd RemoveObj
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Krzysztof-Cieslak/RemoveObj
   ```
